...
if (isset($_SESSION['soudahbooking_cart'])){
  if (count($_SESSION['soudahbooking_cart'])>0) {
    $cart =  count($_SESSION['soudahbooking_cart'])  ;
  } 
...
<!-- Modal photo -->
  ...
  //Validates Personal Info
        ...
        if ((a=="Firstname" || a=="") || (b=="lastname" || b=="") || (d=="address" || d=="") || (e=="dateofbirth" || e=="") || (g=="Phone" || g=="")|| (h=="username" || h=="") || (j=="password" || j==""))
          {
