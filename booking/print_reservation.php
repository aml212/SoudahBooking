...
<div id="accom-title"  > 
    ...
    <form action="index.php?view=payment" method="post"  name="" >
           ...
           Greetings from soudahbooking Beach Resorts!<br/><br/>
          ...
          <tbody>
            ...
            <?php
             ...
             $arival   = $_SESSION['from']; 
              ...
              $mydb->setQuery("SELECT * FROM `tblroom` r, `tblaccomodation` a WHERE  r.`ACCOMID`=a.`ACCOMID` AND `ROOMID` =". $_SESSION['soudahbooking_cart'][$i]['soudahbookingroomid']);
            ...
            foreach ($cur as $result) {
              ...
              echo '<td>'.$_SESSION['soudahbooking_cart'][$i]['soudahbookingcheckin'].'</td>';
              echo '<td>'.$_SESSION['soudahbooking_cart'][$i]['soudahbookingcheckout'].'</td>';
              echo '<td>'.$_SESSION['soudahbooking_cart'][$i]['soudahbookingday'].'</td>';
              echo '<td> &euro;'. $result->PRICE.'</td>';
               echo '<td >1</td>';
                echo '<td >&euro;'. $_SESSION['soudahbooking_cart'][$i]['soudahbookingroomprice'].'</td>';
...
If you have any questions, please email at soudahbooking.com or call (034) 4713 – 135
<br/><br/>
Thank you for choosing Soudah booking 
<br/><br/>
