...
$_SESSION['GUESTID'] =   $lastguest;
    ...
    for ($i=0; $i < $count_cart  ; $i++) { 
            ...
            $reservation->ROOMID            = $_SESSION['soudahbooking_cart'][$i]['soudahbookingroomid'];
            $reservation->ARRIVAL           = date_format(date_create( $_SESSION['soudahbooking_cart'][$i]['soudahbookingcheckin']), 'Y-m-d');  
            $reservation->DEPARTURE         = date_format(date_create( $_SESSION['soudahbooking_cart'][$i]['soudahbookingcheckout']), 'Y-m-d'); 
            $reservation->RPRICE            = $_SESSION['soudahbooking_cart'][$i]['soudahbookingroomprice'];  
            ...
            @$tot += $_SESSION['soudahbooking_cart'][$i]['soudahbookingroomprice'];
            }

           $item = count($_SESSION['soudahbooking_cart']);
...
?>
        ...
        <tr>
          ...
          <td><?php echo  date_format(date_create( $_SESSION['soudahbooking_cart'][$i]['soudahbookingcheckin']),"m/d/Y"); ?></td>
          <td><?php echo  date_format(date_create( $_SESSION['soudahbooking_cart'][$i]['soudahbookingcheckout']),"m/d/Y"); ?></td>
          <td><?php echo  ' &euro;'. $result->PRICE; ?></td>
          <td><?php echo   $_SESSION['soudahbooking_cart'][$i]['soudahbookingday']; ?></td>
          <td><?php echo ' &euro;'.   $_SESSION['soudahbooking_cart'][$i]['soudahbookingroomprice']; ?></td>
        </tr>
<?php
